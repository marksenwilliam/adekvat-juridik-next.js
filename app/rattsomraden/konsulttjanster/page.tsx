...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.adekvatjuridik.se/rattsomraden/konsulttjanster',
  },
  openGraph: {
...
export default function KonsulttjansterPage() {
  const breadcrumbs = [
    ...
    { label: 'Juridisk konsultation', href: '/rattsomraden/konsulttjanster' },
  ];

  // FAQ data for the page
  const faqs = [
    {
      question: 'Vilken typ av företag passar ert upplägg bäst för?',
      answer: 'Löpande juridiskt stöd passar särskilt små och medelstora företag som regelbundet hanterar avtal, kunder, leverantörer eller personalfrågor – men som inte har egen jurist.'
    },
    {
      question: 'Hur fungerar samarbetet i praktiken?',
      answer: 'Ni har en fast kontaktperson, tydliga kontaktvägar och överenskomna svarstider. Vi sätter oss in i er verksamhet för att kunna ge snabb och relevant rådgivning.'
    },
    {
      question: 'Kan ni hjälpa till med "snabba frågor" i vardagen?',
      answer: 'Ja. Vanliga frågor rör avtalstolkning, kundvillkor, betalningsproblem, uppsägningar eller GDPR-relaterade frågor.'
    },
    {
      question: 'Hur jobbar ni proaktivt för att förebygga risker?',
      answer: 'Vi hjälper till att se över och uppdatera avtal, skapa rutiner och policyer samt identifiera juridiska risker innan de leder till problem.'
    },
    {
      question: 'Hur tar ni betalt när det inte finns en fast månadsavgift?',
      answer: 'Vi arbetar oftast på timpris eller enligt överenskommen budget. Tydliga ramar sätts i förväg för att kostnaderna ska vara förutsägbara.'
    }
  ];
  ...
  const serviceSchema = {
    ...
    url: 'https://www.adekvatjuridik.se/rattsomraden/konsulttjanster',
  };
  ...
  return (
    <>
      ...
      <div className="bg-[#050A18] min-h-screen text-gray-200 selection:bg-[#C4A470] selection:text-white overflow-x-hidden">
        ...
        <FAQSection
          faqs={faqs}
          title="Vanliga frågor om konsulttjänster"
          subtitle="Här hittar du svar på de vanligaste frågorna om löpande juridiskt stöd för företag."
        />
