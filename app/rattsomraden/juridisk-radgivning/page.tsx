...
export default function JuridiskRadgivningPage() {
  ...
  const faqs = [
    {
      question: 'Vad innebär den kostnadsfria konsultationen – vad går vi igenom och vad får man med sig efter samtalet?',
      answer: 'Den kostnadsfria konsultationen är ett första orienterande samtal där vi går igenom din situation, vad som hänt och vilka juridiska frågor som är aktuella. Du får en första bedömning av läget, vilka handlingsalternativ som finns och om – och hur – vi kan hjälpa dig vidare. Efter samtalet har du en tydligare bild av nästa steg, tidsramar och möjliga kostnader.'
    },
    {
      question: 'Vilken information eller vilka dokument bör jag ha redo innan jag kontaktar er?',
      answer: 'Det är bra om du kan ta fram relevanta avtal, mejlkonversationer, brev från motpart eller myndighet, fakturor eller annan dokumentation som rör ärendet. Det är dock inget krav – saknas något kan vi hjälpa dig att reda ut vad som behövs.'
    },
    {
      question: 'Hur snabbt kan ni normalt återkomma och hur ser processen ut från första kontakt?',
      answer: 'Vi återkommer vanligtvis inom 1–2 arbetsdagar. Efter första kontakten bokar vi ett inledande samtal, gör en bedömning av ärendet och föreslår upplägg. När du godkänt upplägget kan vi börja arbeta direkt.'
    },
    {
      question: 'Hur tar ni betalt efter första mötet – fast pris, timpris eller offert?',
      answer: 'Beroende på ärendets art erbjuder vi timpris, fast pris eller offert. Innan vi påbörjar arbetet får du alltid information om hur debiteringen sker och en uppskattning av kostnaderna, så att du har full kontroll.'
    },
    {
      question: 'När bör man ta hjälp "tidigt i processen" – vilka är de vanligaste misstagen?',
      answer: 'Det är klokt att ta juridisk hjälp så snart en konflikt, oklarhet eller risk uppstår. Vanliga misstag är att man skriver på avtal utan granskning, väntar för länge med att reklamera eller kommunicerar fel med motparten – något som kan försvaga ens position senare.'
    }
  ];
  ...
  return (
    <>
      ...
      <div className="bg-[#050A18] min-h-screen text-gray-200 selection:bg-[#C4A470] selection:text-white overflow-x-hidden">
        ...
        <FAQSection
          faqs={faqs}
          title="Vanliga frågor om juridisk rådgivning"
          subtitle="Här hittar du svar på de vanligaste frågorna om juridisk rådgivning för privatpersoner och företag."
        />
