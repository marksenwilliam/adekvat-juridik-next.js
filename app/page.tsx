...
export default function Home() {
  return (
    <>
      ...
      {/* Content Wrapper */}
      <div className="z-10 flex flex-col relative" suppressHydrationWarning>
          ...
          <div className="max-w-[1400px] w-full grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-end">
            ...
            <div className="lg:col-span-5 flex flex-col justify-end lg:pb-6 pl-0 lg:pl-10">
              <div className="lg:border-l border-white/10 lg:pl-10 space-y-8">
                ...
                <a href="#om-oss" className="group inline-flex items-center gap-4 mt-4">
        ...
        <section className="lg:py-48 text-[#1a1a1a] bg-[#F9F8F6] w-full pt-32 pb-32 relative" id="om-oss">
          <div className="max-w-[1200px] mx-auto px-6 flex flex-col items-center text-center">
            ...
            {/* Paragraph */}
            <p className="text-xs md:text-sm text-[#666] leading-relaxed max-w-lg mx-auto font-light">
          ...
          <div className="absolute inset-0 opacity-[0.03] pointer-events-none" style={{
            backgroundImage: "url('data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSI0IiBoZWlnaHQ9IjQiPgo8cmVjdCB3aWR0aD0iNCIgaGVpZ2h0PSI0IiBmaWxsPSIjMDAwIi8+Cjwvc3ZnPg==')"
          }}></div>
        </section>

        {/* SECTION 3: Vilka vi är */}
          ...
          <div className="max-w-[1200px] mx-auto px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 xl:gap-24 items-center">
              ...
              <div className="flex flex-col justify-center">
                <span className="text-[10px] tracking-[0.25em] text-[#C4A470] uppercase font-medium mb-6">
                  Vilka vi är
                </span>

                <h2 className="font-serif text-5xl lg:text-6xl tracking-tight leading-[1.05] mb-8 text-[#1a1a1a] font-playfair">
                  Vi hanterar juridiken,
                  <span className="text-[#9ca3af] font-playfair"> så du kan fokusera på livet.</span>
                </h2>
                ...
                <div className="grid grid-cols-3 gap-8">
                  ...
                  <div className="flex flex-col items-start">
                    ...
                    <h4 className="font-serif text-lg text-[#1a1a1a] mb-2 tracking-tight">Tydliga råd</h4>
                    <p className="text-[9px] tracking-widest uppercase text-gray-400 font-medium leading-relaxed">Vi krånglar inte till det.</p>
                  </div>
                  ...
                  <div className="flex flex-col items-start">
                    ...
                    <h4 className="font-serif text-lg text-[#1a1a1a] mb-2 tracking-tight">Raka besked</h4>
                    <p className="text-[9px] tracking-widest uppercase text-gray-400 font-medium leading-relaxed">Ärlighet varar längst.</p>
                  </div>
                  ...
                  <div className="flex flex-col items-start">
                    ...
                    <h4 className="font-serif text-lg text-[#1a1a1a] mb-2 tracking-tight">Personligt</h4>
                    <p className="text-[9px] tracking-widest uppercase text-gray-400 font-medium leading-relaxed">Ditt ärende är unikt.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative h-[650px] lg:h-[750px] w-full group overflow-hidden">
                <div className="absolute inset-0 w-full h-full">
                  <Image
                    src="https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/ff6c94fb-dd52-4770-a6cb-3510b4571bb2_1600w.jpg"
                    alt="Suit Detail"
                    fill
