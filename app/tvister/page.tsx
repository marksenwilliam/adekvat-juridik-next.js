    ...
    <>
      ...
      <div className="flex flex-col z-10 relative">
        ...
        <section className="md:pl-6 md:pb-6 bg-[#0C122B] pt-32 pr-6 pb-32 pl-6" style={{ maskImage: 'linear-gradient(180deg, transparent, black 20%, black 100%, transparent)', WebkitMaskImage: 'linear-gradient(180deg, transparent, black 20%, black 100%, transparent)' }} id="hem">
          <section className="flex flex-col lg:flex-row max-w-5xl mt-20 mr-auto mb-20 ml-auto lg:items-stretch">
            ...
            <div className="flex flex-col z-10 lg:w-7/12 lg:pr-0 lg:pl-5 lg:pt-5 lg:pb-5 border-[#c4a470] border-0 pt-12 pr-6 pb-12 pl-6 relative" style={{ maskImage: 'linear-gradient(0deg, transparent, black 0%, black 100%, transparent)', WebkitMaskImage: 'linear-gradient(0deg, transparent, black 0%, black 100%, transparent)' }}>
              ...
              <h1 className="lg:text-8xl leading-[1.2] text-6xl text-neutral-900 tracking-tighter mb-6">
                <span className="block font-light text-gray-200 font-playfair">Tvistlösning – </span>
                <span className="block text-6xl font-normal text-gray-200 tracking-normal font-playfair">Vi står vid din sida</span>
              </h1>

              <p className="leading-relaxed text-3xl font-normal text-gray-200 tracking-tight font-playfair max-w-xl mr-20 mb-6">Erfaren juridisk representation när konflikten är ett faktum</p>
              <p className="leading-relaxed text-base font-normal text-gray-200 max-w-xl mr-20 mb-6">Ingen vill hamna i en tvist. Men ibland går det inte att undvika – avtal bryts, överenskommelser tolkas olika, och situationer som borde ha löst sig smidigt fastnar i låsta positioner. När det händer behöver du någon som kan föra din talan, skydda dina rättigheter och arbeta målmedvetet mot en lösning.</p>
              <p className="leading-relaxed text-base font-normal text-gray-200 max-w-xl mr-20 mb-6">På Adekvat Juridik har vi omfattande erfarenhet av tvistlösning i alla dess former. Vi hjälper både privatpersoner och företag att hantera konflikter – från första kravbrev till slutlig dom om det krävs.</p>
            ...
            <div className="overflow-hidden bg-center lg:w-5/12 lg:flex-1 h-[400px] lg:h-auto bg-neutral-50/50 w-full bg-[url(https://images.unsplash.com/photo-1505547828843-176834e42154?w=1600&q=80)] bg-cover border-0 relative lg:pt-5 lg:mb-10">
            </div>
          </section>
        </section>
            ...
            <div className="overflow-hidden sm:px-10 lg:px-14 lg:py-14 bg-[#0C122B] ring-gray-200 ring-1 mt-5 mb-10 pt-10 pr-6 pb-10 pl-6 relative left-0 shadow-xl backdrop-blur-none" style={{ boxShadow: '0 25px 50px -12px rgba(2, 2, 2, 0.8), 0 0 30px rgba(196, 164, 112, 0.1)' }}>
              <div className="flex flex-col lg:flex-row gap-x-12 gap-y-12 lg:items-stretch">
                <div className="lg:flex-[3]">
                  <p className="text-[11px] sm:text-xs uppercase font-light text-[#c4a470] tracking-widest mt-0 mr-0 mb-3 ml-0 pt-0">Våra tjänster</p>
                  <h2 className="sm:text-5xl text-3xl font-light text-gray-200 tracking-tight font-playfair bg-gray-200/0 mb-6">Konfliktlösning inom flera områden</h2>
                  ...
                  <div className="space-y-8">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <p className="text-sm text-gray-300 font-light">Tvister kan uppstå i nästan alla sammanhang där människor och organisationer interagerar. Vi har bred kompetens och erfarenhet av att hantera många typer av konflikter.</p>
                      </div>
                    </div>
                    <div className="flex gap-4 items-start">
                      ...
                      <div>
                        <p className="text-sm text-gray-300 font-light">Civilrättsliga tvister omfattar ofta avtalstvister där parterna är oense om avtalets innebörd eller uppfyllande, fordringar och betalningskrav, skadeståndskrav och ersättningsanspråk, samt tvister mellan privatpersoner.</p>
                      </div>
                    </div>
                    <h2 className="sm:text-5xl text-3xl font-light text-gray-200 tracking-tight font-playfair bg-gray-200/0 mb-6 mt-4">Kommersiella tvister</h2>
                    <div className="flex gap-4 items-start">
                      <div className="flex-shrink-0 flex bg-[#C4A470]/10 w-8 h-8 rounded-full items-center justify-center">
                        <span className="text-[#C4A470] font-semibold text-sm">01</span>
                      </div>
                      <div>
                        <p className="text-sm text-gray-300 font-light">Kommersiella tvister inkluderar affärskonflikter mellan företag, tvister med leverantörer eller kunder, samarbetsavtal som fallerat, samt konkurrensrättsliga frågor.</p>
                      </div>
                    </div>
                    <div className="flex gap-4 items-start">
                      <div className="flex-shrink-0 flex bg-[#C4A470]/10 w-8 h-8 rounded-full items-center justify-center">
                      ...
                      <div>
                        <p className="text-sm text-gray-300 font-light">Utredning och analys är alltid första steget. Vi går igenom alla relevanta fakta, dokument och omständigheter. Vad har hänt? Vad säger avtalet eller lagen? Vilka bevis finns? Baserat på detta gör vi en realistisk bedömning av ditt ärende och dina chanser.</p>
                      </div>
                    </div>
                    <div className="flex gap-4 items-start">
                      <div className="flex-shrink-0 flex bg-[#C4A470]/10 w-8 h-8 rounded-full items-center justify-center">
                      ...
                      <div>
                        <p className="text-sm text-gray-300 font-light">Förhandling och dialog är ofta den mest effektiva vägen till en lösning. Innan vi tar steget till domstol försöker vi i de flesta fall nå en överenskommelse med motparten. En förlikning kan spara både tid, pengar och energi.</p>
                      </div>
                    </div>
                    <div className="flex gap-4 items-start">
                      <div className="flex-shrink-0 flex bg-[#C4A470]/10 w-8 h-8 rounded-full items-center justify-center">
                      ...
                      <div>
                        <p className="text-sm text-gray-300 font-light">Många privatpersoner har rätt till rättsskydd genom sin hemförsäkring, vilket innebär att försäkringsbolaget täcker en betydande del av ombudskostnaderna. Vi hjälper dig att kontakta ditt försäkringsbolag och utreda om du kan använda rättsskyddet.</p>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="relative lg:flex-[2] lg:min-h-0">
                  <div className="flex bg-[url(https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=1600&q=80)] bg-cover border-[#c4a470] border ring-[#c4a470]/0 mt-0 mb-0 pt-0 pr-8 pb-0 pl-8 items-end justify-start h-[500px] lg:h-full">
                  </div>
                </div>
              </div>
            </div>
            <div className="overflow-hidden sm:px-10 lg:px-14 lg:py-14 bg-[#0C122B] ring-gray-200 ring-1 mt-10 mb-10 pt-10 pr-6 pb-10 pl-6 relative left-0 shadow-xl" style={{ boxShadow: '0 25px 50px -12px rgba(2, 2, 2, 0.8), 0 0 30px rgba(196, 164, 112, 0.1)' }}>
              <div className="flex flex-col lg:flex-row gap-12 text-[#c4a470] lg:items-stretch">
                <div className="relative lg:flex-[2] lg:min-h-0 order-2 lg:order-1">
                  <div className="flex bg-[url(https://images.unsplash.com/photo-1649653084130-06638e40ca25?w=1600&q=80)] bg-cover bg-center border-[#c4a470] border ring-0 pt-8 pr-8 pb-8 pl-8 items-start justify-end h-[400px] lg:h-full">
                  </div>
                </div>
                <div className="lg:flex-[3] order-1 lg:order-2">
                  ...
                  <h2 className="sm:text-5xl text-3xl font-light text-gray-200 tracking-tight font-playfair mb-6">Strategiskt arbete i varje steg</h2>
                  ...
                  <div className="space-y-6">
                    <div className="flex gap-4 gap-x-4 gap-y-4 items-start">
                      ...
                      <div className="">
                        <p className="text-sm text-gray-200">Utredning och analys är alltid första steget. Vi går igenom alla relevanta fakta, dokument och omständigheter. Vad har hänt? Vad säger avtalet eller lagen? Vilka bevis finns? Baserat på detta gör vi en realistisk bedömning av ditt ärende och dina chanser.</p>
                      </div>
                    </div>
                  </div>
                  <div className="mt-8">
                    <p className="text-[11px] uppercase sm:text-xs font-light text-[#c4a470] tracking-widest mb-3">Kostnader</p>
                    <h2 className="sm:text-5xl text-3xl font-light text-gray-200 tracking-tight font-playfair mb-6">Rättsskydd och kostnadsmedvetenhet</h2>
                    ...
                    <div className="space-y-6">
                      <div className="flex gap-4 gap-x-4 gap-y-4 items-start">
                        ...
                        <div className="">
                          <p className="text-sm text-gray-200">Inför varje ärende gör vi en uppskattning av den förväntade tidsåtgången och kostnaden. Vi håller dig löpande informerad om hur ärendet utvecklas. Du ska aldrig behöva oroa dig för oväntade fakturor.</p>
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <section className="bg-white py-24 lg:py-32 relative z-10">
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <p className="text-lg sm:text-xl lg:text-2xl text-gray-600 font-light leading-relaxed max-w-3xl mx-auto">
              Ju tidigare du söker juridisk hjälp, desto fler alternativ har du. Kontakta oss för en kostnadsfri inledande konsultation där vi går igenom din situation och diskuterar möjliga vägar framåt.
            </p>
          </div>
        </section>
