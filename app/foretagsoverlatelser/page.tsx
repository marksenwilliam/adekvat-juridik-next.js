...
export default function ForetagsoverlatelserPage() {
  return (
    <>
      {/* SECTION 1: Hero */}
      <section className="md:pl-6 md:pb-6 bg-[#0C122B] pt-32 pr-6 pb-32 pl-6" style={{ maskImage: 'linear-gradient(180deg, transparent, black 20%, black 100%, transparent)', WebkitMaskImage: 'linear-gradient(180deg, transparent, black 20%, black 100%, transparent)' }}>
        <section className="flex flex-col lg:flex-row max-w-5xl mt-20 mr-auto mb-20 ml-auto">
          ...
          <div className="flex flex-col z-10 lg:w-7/12 lg:pr-0 lg:pl-5 lg:pt-5 lg:pb-5 border-[#c4a470] border-0 pt-12 pr-6 pb-12 pl-6 relative" style={{ maskImage: 'linear-gradient(0deg, transparent, black 0%, black 100%, transparent)', WebkitMaskImage: 'linear-gradient(0deg, transparent, black 0%, black 100%, transparent)' }}>
            ...
            <h1 className="lg:text-8xl leading-[1.2] text-6xl text-neutral-900 tracking-tighter mb-6">
              <span className="block font-light text-gray-200 font-playfair">Köp & sälj</span>
              <span className="block text-6xl font-normal text-gray-200 tracking-normal font-playfair">av företag</span>
            </h1>

            <p className="leading-relaxed text-3xl font-normal text-gray-200 tracking-tight font-playfair max-w-xl mr-20 mb-6">Juridisk expertis vid företagsöverlåtelser, ägarskiften och förvärv</p>
            <p className="leading-relaxed text-base font-normal text-gray-200 max-w-xl mr-20 mb-6">Att köpa eller sälja ett företag är en av de mest betydelsefulla affärstransaktionerna du kan genomföra. Det handlar om stora värden, komplexa avtal och beslut som påverkar framtiden för alla inblandade.</p>
            <p className="leading-relaxed text-base font-normal text-gray-200 max-w-xl mr-20 mb-6">På Adekvat Juridik har vi lång erfarenhet av att guida både köpare och säljare genom företagsöverlåtelser. Vi ser till att du förstår vad som händer i varje steg, att dina intressen skyddas och att affären genomförs på ett sätt som du kan känna dig trygg med.</p>
          ...
          <div className="overflow-hidden bg-center lg:w-5/12 lg:flex-1 h-[400px] lg:h-auto bg-neutral-50/50 w-full bg-[url(https://images.unsplash.com/photo-1473186505569-9c61870c11f9?w=1600&q=80)] bg-cover border-0 relative lg:pt-5 lg:mb-10"></div>
        </section>
      </section>
          ...
          <div className="overflow-hidden sm:px-10 lg:px-14 lg:py-14 bg-[#0C122B] ring-gray-200 ring-1 rounded-none mt-5 mb-10 pt-10 pr-6 pb-10 pl-6 relative left-0 shadow-xl backdrop-blur-none" style={{ boxShadow: '0 25px 50px -12px rgba(2, 2, 2, 0.8), 0 0 30px rgba(196, 164, 112, 0.1)' }}>
            <div className="flex flex-col lg:flex-row gap-x-12 gap-y-12 lg:items-stretch">
              <div className="lg:flex-[3]">
                <p className="text-[11px] sm:text-xs uppercase font-light text-[#c4a470] tracking-widest mr-0 mb-3 ml-0">För säljare</p>
                <h2 className="sm:text-5xl text-3xl font-light text-gray-200 tracking-tight font-playfair bg-gray-200/0 mb-6">Sälja företag – maximera värdet</h2>
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-sm text-gray-300 font-light">Att sälja ett företag du byggt upp under många år är ofta både en ekonomisk och emotionell resa. Du vill naturligtvis få rätt värde för ditt livsverk, men du vill också att övergången ska fungera smidigt.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4 items-start">
                    ...
                    <div>
                      <p className="text-sm text-gray-300 font-light">Vi hjälper dig att förbereda företaget för försäljning genom att identifiera och åtgärda potentiella problem som kan påverka värderingen eller skrämma bort köpare.</p>
                    </div>
                  </div>

                  <h2 className="sm:text-5xl text-3xl font-light text-gray-200 tracking-tight font-playfair bg-gray-200/0 mb-6 mt-4">Bistånd i förhandlingarna</h2>
                  ...
                  <div className="flex gap-4 items-start">
                    ...
                    <div>
                      <p className="text-sm text-gray-300 font-light">Vi bistår i förhandlingarna för att säkerställa att villkoren är rimliga och att du inte bär mer risk än nödvändigt. Överlåtelseavtalet skyddar dig mot framtida krav och överraskningar.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4 items-start">
                    ...
                    <div>
                      <p className="text-sm text-gray-300 font-light">Due diligence är processen där vi granskar målbolaget på djupet. Vi går igenom avtal, anställningsförhållanden, immateriella rättigheter, pågående tvister, skattesituationen och allt annat som kan påverka bolagets värde.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4 items-start">
                    ...
                    <div>
                      <p className="text-sm text-gray-300 font-light">Vi hjälper dig att strukturera förvärvet på ett optimalt sätt – ska du köpa aktier eller inkråm? Hur ska köpeskillingen betalas? Vilka garantier behöver du från säljaren?</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4 items-start">
                    ...
                    <div>
                      <p className="text-sm text-gray-300 font-light">Varje företagsöverlåtelse är unik, men processen följer oftast en liknande struktur: Inledande fas, sekretessavtal, letter of intent, due diligence, avtalsförhandling och tillträde.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="relative lg:flex-[2] lg:min-h-0">
                <div className="flex bg-[url(https://images.unsplash.com/photo-1502465771179-51f3535da42c?w=1600&q=80)] bg-cover border-[#c4a470] border rounded-none lg:h-full ring-[#c4a470]/0 pt-8 pr-8 pb-8 pl-8 items-end justify-start h-[400px]"></div>
              </div>
            </div>
          </div>
          ...
          <div className="overflow-hidden sm:px-10 lg:px-14 lg:py-14 bg-[#0C122B] rounded-none ring-gray-200 ring-1 mt-10 mb-10 pt-10 pr-6 pb-10 pl-6 relative left-0 shadow-xl" style={{ boxShadow: '0 25px 50px -12px rgba(2, 2, 2, 0.8), 0 0 30px rgba(196, 164, 112, 0.1)' }}>
            <div className="flex flex-col lg:flex-row gap-12 text-[#c4a470] lg:items-stretch">
              ...
              <div className="relative lg:flex-[2] lg:min-h-0 order-2 lg:order-1">
                <div className="flex bg-[url(https://images.unsplash.com/photo-1455390582262-044cdead277a?w=1600&q=80)] bg-cover border-[#c4a470] border ring-0 rounded-none pt-8 pr-8 pb-8 pl-8 items-start justify-end h-[400px] lg:h-full"></div>
              </div>

              <div className="lg:flex-[3] order-1 lg:order-2">
                <p className="text-[11px] sm:text-xs uppercase font-light text-[#c4a470] tracking-widest mb-3">För köpare</p>
                <h2 className="sm:text-5xl text-3xl font-light text-gray-200 tracking-tight font-playfair mb-6">Köpa företag – gör rätt affär</h2>
                ...
                <div className="mt-8">
                  <p className="text-[11px] uppercase sm:text-xs font-light text-[#c4a470] tracking-widest mb-3">Processen</p>
                  <h2 className="sm:text-5xl text-3xl font-light text-gray-200 tracking-tight font-playfair mb-6">Vad du kan förvänta dig</h2>
      ...
      <section className="bg-white py-24 lg:py-32 relative z-10">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-lg sm:text-xl lg:text-2xl text-gray-600 font-light leading-relaxed max-w-3xl mx-auto">
            Låt oss hjälpa dig genom processen. Kontakta oss för en kostnadsfri konsultation där vi går igenom dina planer och visar hur vi kan säkerställa en trygg affär.
          </p>
        </div>
      </section>
